...
namespace Personnel_Database.EmployeeDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([ID] = @Original_ID) AND ([Name] = @Original" +
                "_Name) AND ([Position] = @Original_Position) AND ([Hourly_Pay_Rate] = @Original_" +
                "Hourly_Pay_Rate))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Name], [Position], [Hourly_Pay_Rate]) VALUES (@Nam" +
                "e, @Position, @Hourly_Pay_Rate);\r\nSELECT ID, Name, Position, Hourly_Pay_Rate FRO" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Name] = @Name, [Position] = @Position, [Hourly_Pay_Rate] = @Hourly_Pay_Rate WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Position] = @Original_Position) AND ([Hourly_Pay_Rate] = @Original_Hourly_Pay_Rate));
SELECT ID, Name, Position, Hourly_Pay_Rate FROM Employee WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Position, Hourly_Pay_Rate FROM dbo.Employee";
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Position, decimal Original_Hourly_Pay_Rate) {
        ...
        public virtual int Update(string Name, string Position, decimal Hourly_Pay_Rate, int Original_ID, string Original_Name, string Original_Position, decimal Original_Hourly_Pay_Rate, int ID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Position, decimal Hourly_Pay_Rate, int Original_ID, string Original_Name, string Original_Position, decimal Original_Hourly_Pay_Rate) {
            return this.Update(Name, Position, Hourly_Pay_Rate, Original_ID, Original_Name, Original_Position, Original_Hourly_Pay_Rate, Original_ID);
        }
    }
